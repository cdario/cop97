        //============================================================================
        // Name        : mcop97.cpp
        // Description : a multijunction COP algorithm
        //============================================================================
        ...
        int initialPhase; // will set to coordinated phase
        int idxCurrentPh;
        ...
        int main(int argc, char** argv) {
          ...
          loadFromFile(argv[0]);
          //NEW for simplicity, COP starts at the end of the coordinated phase
          initialPhase = coordinatedPhase; 
        ...
        void RunCOP() {
          ...
          do {
        	...
        	int si = (j!=1) ? (sj-hj) : 0; // si = s_{j-1}

        	int tQueue = 0; int tStops = 0; int tDelay = 0;
        	int index_sj = sj - red;
        	int index_maxPh = -1;
         ...
         *  @param  phi phase index to be dischargedidxCurrentPhidxCurrentPh
         *  @param  xj green time
